...
<header class="site-header">
    <img src="images/murachlogo.jpg" alt="Murach Logo" width="120">
</header>
...
<form action="survey" method="post">
    ...
    <!-- Date of Birth (bước 9, không required) -->
    <label>Date of Birth</label>
    <input type="date" name="dob"><br>

    <h2>How did you hear about us?</h2>
    <p>
        <!-- Search engine mặc định (bước 10) -->
        ...
        <!-- Thêm Social Media trước Other (bước 11) -->
    ...
    <!-- Hai checkbox đều không checked (bước 12) -->
